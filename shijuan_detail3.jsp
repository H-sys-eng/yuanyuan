...
out.print("<script>alert('打分成功!!您本次主观题成绩为"+zcj+"分！主观题由管理员进行手动打分');location.href='cj_list3.jsp';</script>");
}
...
HashMap zzz = new CommDAO().getmap(tmid,"wendati"); 
 ...
 String timu=(String)zzz.get("shiti");
                ...
                <tr>
                  <td>回答：</td>
                  <td colspan="2"> <input name="xueshengdaan" type="text" id="xueshengdaan" value="<%=xsda%>"></td>
                </tr>
                <tr>
                  <td>打分：</td>
