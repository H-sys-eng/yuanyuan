...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  <tr>
	...
	<td width="7%" bgcolor='#A4B6D7'>班级</td>
 ...
 new CommDAO().delete(request,"cj"); 
    ...
    String sql =  "select * from cj where sjbh in(select shijuanbianhao from shijuanshengcheng where tianjiaren='"+request.getSession().getAttribute("username")+"')";
...
%>
  <tr>
    ...
    <td><%=map.get("username") %></td>
	 <td><%=map.get("banji") %></td>
	<td><%=map.get("sjbh") %></td><td><%=map.get("cj") %></td>
    <td><%=map.get("zcj") %></td>
