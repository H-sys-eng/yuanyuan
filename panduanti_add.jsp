...
String sql3=  "select * from panduanti where bianhao='"+request.getParameter("bianhao")+"' and kemumingcheng='"+request.getParameter("kemumingcheng")+"'";
...
new CommDAO().insert(request,response,"panduanti",ext,true,false,""); 
%>

  <body >
 <form  action="panduanti_add.jsp?f=f&id=<%=id%>"  method="post" name="form1"  onsubmit="return checkform();">
  添加判断题:
  <br><br>
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
		<tr><td  width="200">编号：</td><td><input name='bianhao' type='text' id='bianhao' value=''  style='border:solid 1px #000000; color:#666666' />&nbsp;*<label id='clabelbianhao' /></td></tr>
		...
		<tr><td>答案：</td><td><select name='daan' id='daan'><option value="对">对</option><option value="错">错</option></select></td></tr>
