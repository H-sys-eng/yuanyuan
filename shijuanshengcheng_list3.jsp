...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="172" bgcolor='#CCFFFF'>试卷编号</td>
    <td width="149" bgcolor='#CCFFFF'>科目名称</td>
    <td width="202" bgcolor='#CCFFFF'>班级</td>
    <td width="202" bgcolor='#CCFFFF'>单选题</td>
    <td width="160" bgcolor='#CCFFFF'>单选题分值</td>
    <td width="160" bgcolor='#CCFFFF'>判断题</td>
    <td width="136" bgcolor='#CCFFFF'>判断题分值</td>
    <td width="136" bgcolor='#CCFFFF'>填空题</td>
    <td bgcolor='#CCFFFF' width='168' align='left'>填空题分值</td>
    <td bgcolor='#CCFFFF' width='168' align='center'>问答题</td>
    <td bgcolor='#CCFFFF' width='97' align='center'>开始日期</td>
    <td bgcolor='#CCFFFF' width='86' align='center'>结束日期</td>
    <td width="81" bgcolor='#CCFFFF'>添加人</td>
    
	<!--dpinglun1-->
    <td width="142" align="center" bgcolor="CCFFFF">操作</td>
  </tr>
  <% 
  ...
  if(userlist1.size()==1)
{
    ...
    <a href="shijuan_detail.jsp?id=<%=map.get("id")%>&jieshuriqi=<%=map.get("jieshuriqi")%>">开始考试</a><!--qiatnalijne--> </td>
  </tr>
  	<%
		 }
	}
