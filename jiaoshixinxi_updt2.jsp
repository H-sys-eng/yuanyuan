...
%>
  ...
  //lixanxdoxngcxhaxifxen
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     <tr><td>教师编号：</td><td><input name='jiaoshibianhao' type='text' id='jiaoshibianhao' value='<%= mmm.get("jiaoshibianhao")%>' style='border:solid 1px #000000; color:#666666' /></td></tr>
     ...
     <tr><td>所属院系：</td><td><input name='suoshuyuanxi' type='text' id='suoshuyuanxi' value='<%= mmm.get("suoshuyuanxi")%>' style='border:solid 1px #000000; color:#666666' /></td></tr>
     ...
     <tr style="display:none"><td>照片：</td><td><input name='zhaopian' type='text' id='zhaopian' size='50' value='<%= mmm.get("zhaopian")%>' style='border:solid 1px #000000; color:#666666' />&nbsp;<input type='button' value='上传' onClick="up('zhaopian')" style='border:solid 1px #000000; color:#666666'/></td></tr>
